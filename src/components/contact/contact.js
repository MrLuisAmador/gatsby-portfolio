    ...
    return (
        <section id="contact-me" className="scrollto">
            <div className="contact">
                ...
                <form name="contact-me" method="post" action="/success" data-netlify="true"
                      data-netlify-honeypot="bot-field">
                    <input type="hidden" name="bot-field"/>

                    <div className="name-field-container">
                        <input type="text" name="name" size="40" className="wpcf7-form-control-wrap__input"
                               id="your-name" placeholder="Name"/>
                    </div>

                    <div className="email-field-container">
                        <input type="email" name="email" size="40" className="wpcf7-form-control-wrap__input" id="email"
                               placeholder="Email"/>
                    </div>

                    <div className="subject-field-container">
                        <input type="text" name="subject" size="40" className="wpcf7-form-control-wrap__input"
                               id="subject" placeholder="Subject"/>
                    </div>

                    <div className="textarea-field-container">
                    <textarea name="text-area" cols="40" rows="10" className="wpcf7-form-control-wrap__text-area"
